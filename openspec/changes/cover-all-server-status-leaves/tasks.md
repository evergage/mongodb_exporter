...
- [ ] 8.4 Record reports and honest version/corpus/cardinality limits outside the repository; audit that no disposable harness, private key, fixture capture, or production configuration change enters the branch.
